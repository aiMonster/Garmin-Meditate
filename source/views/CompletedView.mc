...
class CompletedView extends WatchUi.View {
    ...
    function setViewElementsColors() as Void {
        _completedLblElement.setColor(Graphics.COLOR_WHITE);
        _activeActionElement.setColor(Graphics.COLOR_WHITE);
        _secondaryActionElement.setColor(Graphics.COLOR_WHITE);
    }
